...
public interface Player {
    ...
    int useAtack(String nomeAtaque); // gastar o ponto de uso e retornar o valor do dano
    int useMagicas(String nomeMagica); // gastar o ponto de uso e retornar o valor do dano
