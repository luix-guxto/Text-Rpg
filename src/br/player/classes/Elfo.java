...
public final class Elfo implements Player {
    ...
    public void init(boolean create) {
        if(create) {
            ...
            xpToUp = 100;
            level = 1;
            atacks[0] = new Atacks(15, "Atirar Flecha",2);
            atacks[1] = new Atacks(25, "Bater com o Arco", 1);
            ...
            lvlArma = LoadGame.getLvlArma(Game.numSave);
