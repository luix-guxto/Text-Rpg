...
public final class Mago implements Player {
    ...
    public boolean unlockMove() {
        if (level >= 5 && atacks[2] == null){
            atacks[2] = new Atacks(8, "Cajadada de fogo", 3);
           ...
           return true;
            ...
            atacks[3] = new Atacks(4, "Cajado elemental", 5);
            unlockedMove = "Cajado elemental";
            return true;
        }
        else if (level >= 30 && magicas[2] == null){
            magicas[2] = new Magicas(7, "Feiche eletrico", 1, 5);
            unlockedMove = "Feiche eletrico";
            return true;
        }
        else if (level >= 50 && magicas[3] == null) {
            magicas[3] = new Magicas(4, "Magica Elemental", 1, 10);
    ...
    public void init(boolean create) {
        if(create){
            ...
            maxLife = life = 100;
            unlockedMove = null;
            atacks[0] = new Atacks(20, "Bater com cajado", 1);
            atacks[1] = new Atacks(15, "Pontada com cajado", 2);
            magicas[0] = new Magicas(10, "Bola de fogo", 1, 2.5);
        }else{
            System.out.println("carregando");
            for (int i = 0; i<4; i++) {
                try{
                    System.out.println("carregando ataques");
                    System.out.println(Game.numSave);
            ...
            for (int i = 0; i<4; i++) {
                try{
                    System.out.println("carregando magicas");
                    System.out.println(Game.numSave);
