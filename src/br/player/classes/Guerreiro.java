...
public final class Guerreiro implements Player {
    ...
    public boolean unlockMove() {
        if(level >= 5 && atacks[2] == null){
            ...
            atacks[3] = new Atacks(3, "Fatiamento", 10);
    ...
    public void init(boolean create) {
        if(create){
            ...
            xpToUp = 100;
            life = maxLife = 100;
            atacks[0] = new Atacks(15, "Espadada", 2);
            atacks[1] = new Atacks(20, "Soco", 1);
            magicas[0] = new Magicas(10, "Espada Flamejante", 1, 2.5);
        }else{
            for (int i = 0; i<4; i++) {
                try{
